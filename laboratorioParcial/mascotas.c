...
void harcodeoRaza(eRaza listaRaza[])
{
    eRaza raza[] = {
    {1, "Pastor","Aleman",1},
    {2, "Bulldog","Frances",1},
...
void mostrarRaza(eRaza listaRaza[],int i)
{
    printf("%d",listaRaza[i].idRaza);


}


void mostraTodaLasRaza(eRaza listaRaza[], int sizeRaza)
{
    int i;
        for(i=0;i<sizeRaza;i++)
            {
                if(listaRaza[i].isEmpty==1)
                    {

                mostrarRaza(listaRaza,i);
                    }
            }
}
...
{
    printf("%2d | %7s \t%10s \t%10s \t%15s\t%15d \t%5.2f \t%5c\n",listarMascotas[i].idMascota,listarMascotas[i].nombre,TipoRaza(listarMascotas[i].tipo),listarMascotas[i].edad,listarMascotas[i].peso,listarMascotas[i].sexo);
}
...
int altaMascota(eMascotas listaMascota[],int sizeMascota, eClientes listaClientes[], int sizeClientes,eRaza listaRaza[],int sizeRaza)
{
    int altaExitosa=-1;
            ...
            if(clientesCargados>=1)
                {
                    ...
                    mostraTodaLasRaza(listaRaza,sizeRaza);

                    getInt(&listaRaza[i].idRaza,"Ingreso de ID:","Error, no son letras\n",1,6,10);
                    ...
                    if(seguir == 'S')
                        {
                            ...
                            do{
                                switch(menuModificacion())
                                {
                                    ...
                                    case 4:
                                            //getCharString(&listaMascotas[indiceEncontrado].,"Ingrese raza de la mascota:","Error, deben ser letras\n",1,50,10);
                                            system("pause");
                                            break;
                                    case 5:
